...
To add a new repository, add a row to the same table. Use `None` for optional columns (Component, Validation commands) when the repository does not have a specific component or validation commands to run.
